# Auth0 jQuery Custom Login Form

This sample demonstrates how to add authentication with a custom login form to a jQuery application using Auth0.
...
Clone the repo or download it from the jQuery quickstart page in Auth0's documentation.
